...
public class Venda {
    ...
    // Retorna um Obejeto Venda:
    // Contendo:
    // - Um ArrayList de produtos, com suas quantidades 
    // - Forma de Pagamento
    // - Valor Total
    // Cada produto possui uma quantidade, alguns possuem quantidade 0, não mostrar na relação de venda
